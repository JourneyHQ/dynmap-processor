...
fun optimizeAreaLines(name: String, coordinates: List<MinecraftCoordinate>): Pair<List<LineMarker>, List<LineMarker>> {
    val xOptimizedLines = mutableListOf<Pair<MinecraftCoordinate, MinecraftCoordinate>>()
    val yOptimizedLines = mutableListOf<Pair<MinecraftCoordinate, MinecraftCoordinate>>()
     ...
     */
    fun checkDirection(line: Pair<MinecraftCoordinate, MinecraftCoordinate>): Direction? {
    ...
    xOptimizedLines.addAll(xRequiredLines)
    yOptimizedLines.addAll(yRequiredLines)

    return xOptimizedLines to yOptimizedLines
}
